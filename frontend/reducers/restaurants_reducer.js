...
const restaurantsReducer = (
  state = { allRestaurants: {}, filterRestaurants: {} },
  action
) => {
  switch (action.type) {
    ...
    case RECEIVE_RESTAURANT:
      ...
      nextState.allRestaurants[action.payload.restaurant.id] =
        action.payload.restaurant;
      return nextState;
    case UPDATE_FILTER:
      let newRestaurants = resSelector(
    ...
    case UPDATE_FILTER_RESTAURANTS:
      return {
        filterRestaurants: action.restaurants,
        allRestaurants: state.allRestaurants,
      };
    case RECEIVE_USER:
